...
Rename the `Auth0.plist.example` file to `Auth0.plist`, and replace the `{yourClientId}` and `{yourDomain}` placeholders with the Client ID and domain of your Auth0 application.
